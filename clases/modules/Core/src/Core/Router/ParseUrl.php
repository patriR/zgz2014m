...
class ParseUrl{
    ...
    public static function parseURL()
    {
        ...
        // Si la url solo consta del dominio se utiliza el controlador 
        // y la accion por defecto
        ...
        if (empty($parts[0])) {
            ...
            $controller_src = $_SERVER['DOCUMENT_ROOT'] . "/../modules/Application/src/Application/controllers/$this->controller.php";
